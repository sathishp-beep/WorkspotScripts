# Workspot Media Extension Uninstall & Cleanup GUI Tool
...
$form.Text = "Workspot Media Extension Cleanup Tool"
...
$titleLabel.Text = "Workspot Media Extension Uninstall / Reinstall Tool"
$titleLabel.Font = New-Object System.Drawing.Font("Segoe UI",14,[System.Drawing.FontStyle]::Bold)
$titleLabel.ForeColor = [System.Drawing.Color]::MidnightBlue
$titleLabel.AutoSize = $true
$titleLabel.Location = New-Object System.Drawing.Point(15,22)
...
$webMediaExtension = New-Object System.Net.WebClient
$bytes = $webMediaExtension.DownloadData($logoUrl)
...
$urlLabel.Text = "Workspot Media Extension Download Link:"
...
$buttonUninstall.Text = "Uninstall Workspot Media Extension"
...
$buttonInstall.Text = "Re-Install Workspot Media Extension"
...
Update-Status "`nStarting Workspot WME uninstall..."
...
Update-Status "`n[Step 1] Searching for Workspot WME installation..."
...
Where-Object { $_.DisplayName -eq "Workspot Media Extension" }

if (!$app){

Update-Status "⚠ Workspot Media Extension not found"
...
$arguments = "/x $productCode /qn /norestart /l*v C:\Temp\WorkspotWME_Uninstall.log"

Start-Process "msiexec.exe" -ArgumentList $arguments -Wait

Update-Status "✓ Workspot Media Extension uninstalled"
...
$msiPath = "C:\Temp\WorkspotMedia Extension.msi"
...
Update-Status "Installing Workspot Media Extension silently..."

$arguments = "/i `"$msiPath`" /qn /norestart /l*v C:\Temp\Workspot_Install.log"

Start-Process "msiexec.exe" -ArgumentList $arguments -Wait

Update-Status "✓ Workspot Media Extension installed successfully"
